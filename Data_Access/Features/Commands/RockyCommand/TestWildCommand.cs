...
{
    public class TestWildCommand : IRequest<Response<ValueSpinRespone>>
    {
    ...
    public class TestWildCommandHandler : IRequestHandler<TestWildCommand, Response<ValueSpinRespone>>
    {
        ...
        public TestWildCommandHandler(IHttpContextAccessor accessor, MyDBContext Contextt)
        {
            _accessor = accessor;
            Context = Contextt;
        ...
        public async Task<Response<ValueSpinRespone>> Handle(TestWildCommand request, CancellationToken cancellationToken)
        {
            ...
            int[] symbol = new int[15] { 0, 0, 0, 0, 0, 7, 7, 7, 7, 7, 1, 1, 1, 1, 1 }; 
