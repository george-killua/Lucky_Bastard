...
{
    public class TestWildBonusCommand:IRequest<Response<ValueSpinRespone>>
    {
    ...
    public class TestWildBonusCommandHandler : IRequestHandler<TestWildBonusCommand, Response<ValueSpinRespone>>
    {
        ...
        public TestWildBonusCommandHandler(IHttpContextAccessor accessor, MyDBContext Contextt)
        {
            _accessor = accessor;
            Context = Contextt;
        ...
        public async Task<Response<ValueSpinRespone>> Handle(TestWildBonusCommand request, CancellationToken cancellationToken)
        {
